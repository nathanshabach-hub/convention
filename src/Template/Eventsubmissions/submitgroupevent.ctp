...
<div class="container-fluid p-0">
	<div class="row">
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<h2 class="mt-3">Submit Group Event</h2>
			...
			<div class="dashboard-form">
				...
				<div class="form-group">
					...
					<div class="input-multiple">
						<?php echo $crstudentEventsD->group_name; ?>
					</div>
				</div>
				
				<div class="form-group">
					<label for="name">Students In Group</label>
					<div class="input-multiple">
						<?php echo $groupStudentList; ?>
					</div>
				</div>
				...
				?>
				<div class="form-group">
					<label for="event_document">Information Required</label>
					<div class="input-multiple">
						...
						One of the following is required for entry into this event:<br />
						Context/Purpose<br />
						Title<br />
						Bible translation being used (Bible memory only) <br />
						Please check guidelines if unsure what is required for this event.
						</span>
					</div>
				</div>
				<?php
