	...
	<div class="row">
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<div class="teachers-top-heading">
				<span>Soccer Kick Event Entries :: <?php echo $eventD->event_name; ?> (<?php echo $eventD->event_id_number; ?>)</span>
			...
			<div class="m_content" id="listID">
				<?php echo $this->element("Eventsubmissions/soccerkickeventsentries"); ?>
			</div>
