                ...
                <table id="name_tags" class="table table-bordered table-striped table-condensed cf">
                    <thead class="cf ajshort">
                        <tr>
                            ...
                            <th class="sorting_paging">School/Company</th>
                    ...
                    <tbody>
                        <?php foreach ($nametags as $datarecord) { ?>
                            <tr>
                                ...
                                <td data-title="School"><?php echo $datarecord->school_company;?>
								</td>
								<td data-title="Action">
                                    
                                    <?php echo $this->Html->link('<i class="fa fa-pencil"></i>', ['controller' => 'nametags', 'action' => 'editvisitor',$datarecord->id], [ 'escape' => false, 'title' => 'Edit', 'class'=>'btn btn-primary btn-xs']); ?>
                                    <?php echo $this->Html->link('<i class="fa fa-trash-o"></i>', ['controller' => 'nametags', 'action' => 'deletevisitor',$datarecord->id], [ 'escape' => false, 'title' => 'Delete', 'class'=>'btn btn-danger btn-xs action-list delete-list', 'confirm' => 'Are you sure you want to Delete ?']); ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
