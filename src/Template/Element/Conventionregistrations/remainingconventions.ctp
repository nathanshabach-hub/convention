                    ...
                    <tbody>
                        <?php foreach ($remainingconventions as $datarecord) { ?>
                            ...
                            <tr>
								...
								<?php
								echo $this->Html->link('Register', ['controller' => 'conventionregistrations', 'action' => 'registerfornewconvention', $datarecord->slug,$seasonD->id], [ 'escape' => false, 'title' => 'Register Now', 'class' => 'btn btn-primary', 'confirm' => 'Are you sure you want to register for this convention?']);
								?>
								</td>
                            </tr>
                        <?php } ?>
