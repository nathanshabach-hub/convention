            ...
            <?php echo $this->Form->create($divisions, ['id'=>'adminForm', 'type' => 'file']); ?>
                <div class="form-horizontal">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <?php echo $this->Form->select('Divisions.eventcategory_id', $eventCatDD, ['id' => 'eventcategory_id', 'label' => false, 'div' => false, 'class' => 'form-control required', 'autocomplete' => 'off']); ?>
							<script>
								$(document).ready(function() {
                    ...
                    <div class="box-footer">
                        ...
                        <?php echo $this->Form->input('Divisions.id', ['label'=>false, 'type'=>'hidden']); ?>
