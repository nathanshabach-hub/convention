...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
			Events of the heart students - <?php echo $conventionD->name; ?> > <?php echo $conventionSD->season_year; ?>
      </h1>
      <ol class="breadcrumb">
          ...
          <li class="active">Events of the heart students</li>
      </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="m_content" id="listID">
                <?php echo $this->element("Admin/Heartevents/listheartevents"); ?>
            </div>
