...
<?php
if(!empty($evaluationareas->evaluationquestion_ids))
{
	$evaluationquestion_ids_explode = explode(",",$evaluationareas->evaluationquestion_ids);
}
?>
<div class="content-wrapper">
    <section class="content-header">
      <h1>
         Edit Area :: Form -> <?php echo $formD->name; ?>
      </h1>
      <ol class="breadcrumb">
            ...
            <?php echo $this->Form->create($evaluationareas, ['id'=>'adminForm', 'type' => 'file']); ?>
                <div class="form-horizontal">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <?php echo $this->Form->select('Evaluationareas.evaluationquestion_ids', $questionsDD, ['id' => 'evaluationquestion_ids', 'label' => false, 'div' => false, 'class' => 'form-control required', 'autocomplete' => 'off', 'multiple' => 'multiple', 'value' => $evaluationquestion_ids_explode]); ?>
							<script>
								$(document).ready(function() {
