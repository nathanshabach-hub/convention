        ...
        <div class="box box-info">
			...
			<div class="admin_search">
               <div class="admin_asearch">
				...
				<?php echo $this->Html->link('<i class="fa fa-print"></i> Print', ['controller'=>'schedulingreports', 'action'=>'byroomsshowprint',$convention_season_slug,$room_id], ['escape'=>false, 'class'=>'btn btn-default', 'target'=>'_blank']);?> 
				
				<?php echo $this->Html->link('Back', ['controller'=>'schedulingreports', 'action'=>'byrooms',$convention_season_slug], ['escape'=>false, 'class'=>'btn btn-warning']);?>
