...
<div class="content-wrapper admin-list-page admin-seasons-master-page">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
          ...
          <li class="active"> Seasons List </li>
      </ol>
    </section>
                ...
                <?php echo $this->Form->create(Null, ['id'=>'adminSearch']); ?>
                    <div class="form-group align_box dtpickr_inputs">
                       ...
                       <div class="admin_asearch">
                            ...
                            <div class="ad_cancel"> <?php echo $this->Html->link('Clear Search', ['controller'=>'seasons', 'action'=>'index'], ['escape'=>false, 'class'=>'btn btn-default canlcel_le']);?></div>
                       </div>
                    </div>
